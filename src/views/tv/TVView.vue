        ...
        <div class="absolute bottom-0 left-0 w-full p-4 md:p-6 flex flex-col md:flex-row items-start md:items-end">
          ...
          <div class="w-full md:flex-1">
            ...
            <div class="flex flex-wrap items-center gap-3 mb-3 text-sm text-white/90">
              <span class="bg-red px-2 py-0.5 rounded-sm">{{ Number(tvShow.vote_average).toFixed(1) }}</span>
              <span>{{ tvShow.first_air_date?.substring(0, 4) }}</span>
              <span>{{ tvShow.number_of_seasons }} saison{{ tvShow.number_of_seasons > 1 ? 's' : '' }}</span>
            </div>
          ...
          >
            ...
            <div class="p-3 flex-1">
              ...
              <div class="flex justify-between mt-1 text-sm text-white/70">
                <span>{{ season.episode_count }} épisode{{ season.episode_count > 1 ? 's' : '' }}</span>
