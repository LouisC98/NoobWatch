    ...
    try {
      ...
      const options = {
        params: {
          key: ytKey,
          part: 'snippet',
          q: `${film.value.title} official film trailer VF`,
          type: 'video',
          maxResults: 1
        }
      }
...
const filmRuntime = computed(() => {
  if (!film.value || !film.value.runtime) return ''
...
<template>
  ...
  <div v-else-if="film" class="-mx-2 sm:mx-0">
      ...
      <div class="w-full h-[50vh] md:h-[60vh] relative">
        ...
        >
          ...
          <div class="w-full md:flex-1">
            <h1 class="text-3xl md:text-4xl font-bold mb-2 text-white">{{ film.title }}</h1>
    ...
    <div class="px-4 py-6">
      ...
      <section class="mb-8">
        ...
        <p v-if="film.overview" class="text-white/80 leading-relaxed">
          {{ film.overview }}
        </p>
